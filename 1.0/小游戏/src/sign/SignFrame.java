...
public class SignFrame extends JFrame implements Userfunction {
    ...
    public SignFrame(){
        ...
        MybuttonListener mybuttonListener =new MybuttonListener(this,this);
    ...
    public Usermassage getUsermassage(){
